...
namespace NumericsLabs
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void RefreshIterGraph()
        {
            ...
            var hm = HeatVisualizer.Plot.AddHeatmap(controller.GetIterationResult((int)IterationSlider.Value), ScottPlot.Drawing.Colormap.Balance);
            hm.Smooth = true;
        ...
        private void RefreshAnalyticalGraph()
        {
            ...
            var hm = AnanylitcalHeatVisualizer.Plot.AddHeatmap(controller.GetAnalyticalResult(), ScottPlot.Drawing.Colormap.Balance);
            hm.Smooth = true;
