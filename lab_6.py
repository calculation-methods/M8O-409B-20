...
# f1=1 - Аппроксимация второго начального условия с первым порядком ; f1=2 - Аппроксимация второго начального условия со вторым порядком 
# f2=1 - явная схема крест ; f2=2 - неявная схема
